...
- Валидация данных на уровне DTO с атрибутами
...
DTO (Data Transfer Object) с автоматической валидацией через атрибуты.
...
```php
$fileIds = $this->handleFiles($_FILES['files']);
// [123, 456, 789]
```
...
$fileIds = $uploader->upload($_FILES['files']);
