<?
$localOptionsFileName = 'beeralex_reviews_options.php';
...
if(file_exists($bitrixPath . $basePathToOptions)) {
    $beeralex_reviews_default_option = include $bitrixPath . $basePathToOptions;
} elseif (file_exists($localPath . $basePathToOptions)) {
    $beeralex_reviews_default_option = include $localPath . $basePathToOptions;
}